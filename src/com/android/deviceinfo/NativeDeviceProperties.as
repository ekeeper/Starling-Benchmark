package com.android.deviceinfo {
	...
	public class NativeDeviceProperties {
		...
		public static var PRODUCT_CPU_HZ : NativeDevicePropertiesData 		= new NativeDevicePropertiesData("ro.product.processor", "PRODUCT_CPU_HZ");
		public static var PRODUCT_RAM : NativeDevicePropertiesData 			= new NativeDevicePropertiesData("ro.product.ram", "PRODUCT_RAM");
		...
		public static var DEVICE_PROPERTIES:Array = new Array(OS_NAME, OS_VERSION, OS_BUILD, OS_SDK_VERSION, OS_SDK_DESCRIPTION, PRODUCT_MODEL, PRODUCT_BRAND, PRODUCT_NAME, PRODUCT_VERSION, PRODUCT_BOARD, PRODUCT_CPU, PRODUCT_CPU_HZ, PRODUCT_RAM, PRODUCT_MANUFACTURER, OPENGLES_VERSION, LCD_DENSITY, DALVIK_HEAPSIZE);
	}
}
